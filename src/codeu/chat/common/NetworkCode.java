...
public final class NetworkCode {
  ...
  public static final int
      ...
      GET_SERVER_INFO_REQUEST = 31,
      GET_SERVER_INFO_RESPONSE = 32,
      ...
      NEW_PERMISSION_CHANGE_REQUEST = 45,
      NEW_PERMISSION_CHANGE_RESPONSE = 46,
      NEW_CLEVER_BOT_REQUEST = 47,
      NEW_CLEVER_BOT_RESPONSE = 48;
}
